    ...
    public function run(): void
    {
        ...
        \DB::table('rides')->insert([
            [
                ...
                'rider_id'     => 1,  // John Rider (riders.id)
                'pickup_lat'   => -6.8167,
                'pickup_lng'   => 39.2800,
                'dest_lat'     => -6.8200,
                'dest_lng'     => 39.2830,
            ...
            [
                ...
                'rider_id'     => 2,  // Jane Rider (riders.id)
                'pickup_lat'   => -6.8167,
                'pickup_lng'   => 39.2800,
                'dest_lat'     => -6.8250,
                'dest_lng'     => 39.2900,
        ...
        \DB::table('ratings')->insert([
            [
                'ride_id'      => 1,
                'from_user_id' => 2,  // John Passenger rates
                'to_user_id'   => 5,  // John Rider (users.id) receives rating
                'rating'       => 5,
            ...
            [
                'ride_id'      => 1,
                'from_user_id' => 5,  // John Rider (users.id) rates
